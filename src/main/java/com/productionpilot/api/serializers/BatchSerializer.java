...
public class BatchSerializer extends StdSerializer<Batch> {
    ...
    public void serialize(Batch value, JsonGenerator gen, SerializerProvider provider) throws IOException {
        ...
        gen.writeStringField("creationTime",
                ApiFormatters.API_DATETIME_FORMATTER.format(value.getCreationTime()));
        gen.writeStringField("modificationTime",
                ApiFormatters.API_DATETIME_FORMATTER.format(value.getModificationTime()));
        gen.writeObjectField("parentBatchId",
