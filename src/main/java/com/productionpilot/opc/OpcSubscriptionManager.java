...
public interface OpcSubscriptionManager {
    default OpcSubscription subscribe(OpcNode node, Duration reportingInterval,
                                      OpcSubscriptionListener listener) {
        return subscribe(node.getId(), reportingInterval, listener);
    }

    default OpcSubscription subscribe(OpcNodeId nodeId, Duration reportingInterval,
                                      OpcSubscriptionListener listener) {
